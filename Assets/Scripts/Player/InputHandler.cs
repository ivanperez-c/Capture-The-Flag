...
public class InputHandler : NetworkBehaviour
{
    ...
    // Variables para las acciones del jugador
    ...
    // Eventos que se producen al realizar las acciones
    ...
    public Vector2 CachedMoveInput { get; set; }

    #endregion

    #region Unity Event Functions

    // Asignación de teclas a los movimientos
    private void Awake()
    {
    ...
    // Actualización de las variables relacionadas con las acciones del jugador
    private void Update()
    {
        if (IsLocalPlayer)
        {
